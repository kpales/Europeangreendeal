<?php 
/**
 * Displays the content when the cover template for homepage is used.
 *
 * @package WordPress
...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	if ( $image_url ) {
			...
			$handy =  get_field( 'handy' )['url'];
			if ( isMobileDevice() ) {
				$cover_header_style   = ' style="background-image: url( ' . $handy . ' );"';
			} else {
...
<video class="bg-video bg-video--desktop" muted playsinline="" loop="" autoplay="" aria-label="header video" src="https://histocon.de/wp-content/uploads/2020/03/6067_histocon_animation_website_21zu9.mp4"></video>
<video class="bg-video bg-video--mobile" muted playsinline="" loop="" autoplay="" aria-label="header video" src="https://histocon.de/wp-content/uploads/2020/02/6067_histocon_animation_hochformat_Website_V01.mp4" ></video>
					...
					<header class="entry-header has-text-align-center">
						<div class="entry-header-inner section-inner medium">
							...
							if ( true === $show_categories && has_category() ) {
								...
								if ( !is_home() && !is_front_page() && !is_page(438) ) :
