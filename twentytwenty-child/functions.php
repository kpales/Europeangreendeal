...
function my_theme_enqueue_styles() {
    ...
    wp_enqueue_style( $parent_style, get_template_directory_uri() . '/style.css?v=131zph6tf2r' );
    ...
    wp_enqueue_script( 'website-script', '/wp-content/themes/twentytwenty-child/js/scripts.js?v=311pgug6zrf2', array(), '1.0.0', true );
}
...
// add attachment to confirmation email
